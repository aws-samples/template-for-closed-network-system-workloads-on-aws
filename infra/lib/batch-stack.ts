...
import { EcsJob } from './constructs/ecs/ecs-job';
import { Bucket } from './constructs/s3/bucket';
import { Construct } from 'constructs';
import { NagSuppressions } from 'cdk-nag';
import { EncryptionKey } from './constructs/kms/key';
...
export class BatchStack extends Stack {
  constructor(scope: Construct, id: string, props: BatchStackProps) {
    ...
    const vpc = aws_ec2.Vpc.fromLookup(this, 'BaseVpc', {
      isDefault: false,
      vpcId: props.vpcId,
    });
    ...
    job0001.task.connections.allowTo(sgForAurora, aws_ec2.Port.tcp(5432));
    job0002.task.connections.allowTo(sgForAurora, aws_ec2.Port.tcp(5432));
    job0003.task.connections.allowTo(sgForAurora, aws_ec2.Port.tcp(5432));
    job0004.task.connections.allowTo(sgForAurora, aws_ec2.Port.tcp(5432));
    job0005.task.connections.allowTo(sgForAurora, aws_ec2.Port.tcp(5432));
