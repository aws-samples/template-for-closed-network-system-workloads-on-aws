...
import { aws_lambda_nodejs,aws_lambda,aws_ec2,aws_iam,Duration,Fn,aws_kms,aws_secretsmanager } from 'aws-cdk-lib';
...
export class DefaultLambda extends Construct {
  ...
  lambdaFunctionRole.addManagedPolicy(aws_iam.ManagedPolicy.fromManagedPolicyArn(this,'awslambdabasicexectionrole',"arn:aws:iam::aws:policy/service-role/AWSLambdaBasicExecutionRole"))
  lambdaFunctionRole.addManagedPolicy(aws_iam.ManagedPolicy.fromManagedPolicyArn(this,'awslambdavpcexectionrole',"arn:aws:iam::aws:policy/service-role/AWSLambdaVPCAccessExecutionRole"))
  lambdaFunctionRole.addToPolicy(new aws_iam.PolicyStatement({
  ...
  this.lambda = new aws_lambda_nodejs.NodejsFunction(this, props.resourceId, {
    ...
    //Suppressions
  NagSuppressions.addResourceSuppressions(lambdaFunctionRole, [
    {
